...
import { CELL_SIZE, GRID_COLS, GRID_ROWS, HUD_HEIGHT, createInitialState } from './types';
...
export class BrickBuilderEngine {
  ...
  constructor(canvas: HTMLCanvasElement, onExit: () => void, helpData: GameHelp) {
    ...
    this.inputSystem = new InputSystem(this.state, canvas, onExit, this.buildSystem);
