...
export class GameRenderer implements Renderable<BrickBuilderState> {
  ...
  private renderGrid(ctx: CanvasRenderingContext2D, state: BrickBuilderState): void {
  ...
  private renderPlacedBricks(ctx: CanvasRenderingContext2D, state: BrickBuilderState): void {
    const ox = state.gridOffsetX;
    const oy = state.gridOffsetY;
  ...
  private renderHoverPreview(ctx: CanvasRenderingContext2D, state: BrickBuilderState): void {
