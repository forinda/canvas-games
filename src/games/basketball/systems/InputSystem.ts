...
export class InputSystem implements InputHandler {
  ...
  constructor(
    ...
    this.mouseDownHandler = (e: MouseEvent) => this.handleDown(this.canvasX(e.clientX), this.canvasY(e.clientY));
    this.mouseMoveHandler = (e: MouseEvent) => this.handleMove(this.canvasX(e.clientX), this.canvasY(e.clientY));
