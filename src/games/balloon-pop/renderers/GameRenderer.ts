...
export class GameRenderer implements Renderable<BalloonState> {
  ...
  private drawBalloons(ctx: CanvasRenderingContext2D, balloons: Balloon[]): void {
  ...
  private drawBalloon(ctx: CanvasRenderingContext2D, b: Balloon): void {
    ...
    ctx.beginPath();
    ctx.ellipse(x - r * 0.25, y - r * 0.35, r * 0.2, r * 0.3, -0.4, 0, Math.PI * 2);
    ctx.fill();
  ...
  private drawParticles(ctx: CanvasRenderingContext2D, particles: PopParticle[]): void {
