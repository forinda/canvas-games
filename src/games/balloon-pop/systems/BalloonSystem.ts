...
export class BalloonSystem implements Updatable<BalloonState> {
  ...
  private spawnBalloon(state: BalloonState): void {
    const radius = BALLOON_RADIUS_MIN + Math.random() * (BALLOON_RADIUS_MAX - BALLOON_RADIUS_MIN);
