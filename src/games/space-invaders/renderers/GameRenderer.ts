...
const SPRITE_SMALL: number[] = [
	...
	0b10111111101, 0b10100000101, 0b00011011000,
];
const SPRITE_SMALL_W = 11;

const SPRITE_MEDIUM: number[] = [
	0b00100000100, 0b10010001001, 0b10111111101, 0b11101110111, 0b11111111111,
	0b01111111110, 0b00100000100, 0b01000000010,
];
const SPRITE_MEDIUM_W = 11;

const SPRITE_LARGE: number[] = [
	0b00001111100000, 0b01111111111100, 0b11111111111110, 0b11100110011100,
	0b11111111111110, 0b00011001100000, 0b00110110110000, 0b11000000001100,
];
