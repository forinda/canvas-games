...
export class GameRenderer implements Renderable<HangmanState> {
  ...
  private drawCategoryHint(ctx: CanvasRenderingContext2D, state: HangmanState): void {
    const W = state.canvasWidth;
  ...
  private drawGallows(ctx: CanvasRenderingContext2D, state: HangmanState): void {
    const W = state.canvasWidth;
    const centerX = W / 2;
    const baseY = 240;
  ...
  private drawWordBlanks(ctx: CanvasRenderingContext2D, state: HangmanState): void {
    const W = state.canvasWidth;
  ...
  private drawKeyboard(ctx: CanvasRenderingContext2D, state: HangmanState): void {
