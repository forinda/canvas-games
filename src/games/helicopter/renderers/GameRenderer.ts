...
export class GameRenderer implements Renderable<HelicopterState> {
  ...
  private drawStars(ctx: CanvasRenderingContext2D, state: HelicopterState): void {
  ...
  private drawCave(ctx: CanvasRenderingContext2D, state: HelicopterState): void {
    ...
    const bottomGrad = ctx.createLinearGradient(0, state.canvasH * 0.6, 0, state.canvasH);
  ...
  private drawObstacles(ctx: CanvasRenderingContext2D, state: HelicopterState): void {
  ...
  private drawHelicopter(ctx: CanvasRenderingContext2D, state: HelicopterState): void {
