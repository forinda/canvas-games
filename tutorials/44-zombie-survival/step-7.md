...
- **The complete, polished game** matching the source at `src/games/zombie-survival/`
...
**File:** `src/games/zombie-survival/adapters/PlatformAdapter.ts`
...
**File:** `src/games/zombie-survival/index.ts`

Exports the game definition for the launcher registry.

```typescript
import type { GameDefinition, GameInstance } from '@shared/GameInterface.ts';
