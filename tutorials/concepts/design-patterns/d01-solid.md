...
### Used In These Games
- **Entire codebase**: `Updatable`, `Renderable`, and `InputHandler` are three separate interfaces in `src/shared/`. No class is forced to implement methods it does not need.
