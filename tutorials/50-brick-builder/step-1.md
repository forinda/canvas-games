...
**File:** `src/games/brick-builder/types.ts`
...
**File:** `src/games/brick-builder/data/bricks.ts`
...
**File:** `src/games/brick-builder/renderers/GameRenderer.ts`
...
**File:** `src/games/brick-builder/adapters/PlatformAdapter.ts`
...
**File:** `src/games/brick-builder/index.ts`
