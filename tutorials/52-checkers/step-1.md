...
**File:** `src/games/checkers/types.ts`
...
**File:** `src/games/checkers/data/constants.ts`
...
**File:** `src/games/checkers/adapters/PlatformAdapter.ts`
...
**File:** `src/games/checkers/index.ts`
