...
**File:** `src/games/fishing/systems/InputSystem.ts`
...
**File:** `src/games/fishing/systems/CastingSystem.ts`
...
**File:** `src/games/fishing/renderers/HUDRenderer.ts`
...
**File:** `src/games/fishing/renderers/SceneRenderer.ts`
...
**File:** `src/games/fishing/FishingEngine.ts`
