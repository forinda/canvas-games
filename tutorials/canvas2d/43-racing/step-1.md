...
**File:** `src/contexts/canvas2d/games/racing/types.ts`
...
**File:** `src/contexts/canvas2d/games/racing/data/tracks.ts`
...
**File:** `src/contexts/canvas2d/games/racing/renderers/TrackRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/racing/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/racing/index.ts`
