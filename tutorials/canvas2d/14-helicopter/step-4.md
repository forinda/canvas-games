...
**File:** `src/contexts/canvas2d/games/helicopter/types.ts`
...
**File:** `src/contexts/canvas2d/games/helicopter/systems/InputSystem.ts`
...
**File:** `src/contexts/canvas2d/games/helicopter/systems/PhysicsSystem.ts`
...
**File:** `src/contexts/canvas2d/games/helicopter/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/helicopter/index.ts`
