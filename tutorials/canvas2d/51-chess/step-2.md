...
**File:** `src/contexts/canvas2d/games/chess/renderers/BoardRenderer.ts` -- updated `drawBoard` method
...
**File:** `src/contexts/canvas2d/games/chess/systems/InputSystem.ts`
...
**File:** `src/contexts/canvas2d/games/chess/ChessEngine.ts` -- updated
