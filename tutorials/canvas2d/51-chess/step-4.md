...
**File:** `src/contexts/canvas2d/games/chess/systems/MoveSystem.ts` -- add these methods to the class
...
**File:** `src/contexts/canvas2d/games/chess/systems/GameSystem.ts`
...
**File:** `src/contexts/canvas2d/games/chess/renderers/HUDRenderer.ts`
