...
**File:** `src/contexts/canvas2d/games/chess/systems/AISystem.ts`
...
The complete source code is at `src/contexts/canvas2d/games/chess/`. You now have a deep understanding of board game state management, tree search algorithms, and Canvas-based game UI.
