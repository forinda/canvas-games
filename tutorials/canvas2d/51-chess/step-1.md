...
**File:** `src/contexts/canvas2d/games/chess/types.ts`
...
**File:** `src/contexts/canvas2d/games/chess/data/pieces.ts`
...
**File:** `src/contexts/canvas2d/games/chess/renderers/BoardRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/chess/ChessEngine.ts`
...
**File:** `src/contexts/canvas2d/games/chess/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/chess/index.ts`
