...
**File:** `src/contexts/canvas2d/games/checkers/systems/MoveSystem.ts`
...
**File:** `src/contexts/canvas2d/games/checkers/systems/GameSystem.ts`
...
**File:** `src/contexts/canvas2d/games/checkers/systems/InputSystem.ts`
