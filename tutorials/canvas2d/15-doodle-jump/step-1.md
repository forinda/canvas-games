...
**File:** `src/contexts/canvas2d/games/doodle-jump/types.ts`
...
**File:** `src/contexts/canvas2d/games/doodle-jump/systems/PhysicsSystem.ts`
...
**File:** `src/contexts/canvas2d/games/doodle-jump/systems/InputSystem.ts`
...
**File:** `src/contexts/canvas2d/games/doodle-jump/renderers/GameRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/doodle-jump/adapters/PlatformAdapter.ts`
