...
**File:** `src/contexts/canvas2d/games/tower-defense/data/enemies.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/systems/EnemySystem.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/renderers/EnemyRenderer.ts`
