...
**File:** `src/contexts/canvas2d/games/tower-defense/data/towers.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/systems/InputSystem.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/renderers/TowerRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/renderers/UIRenderer.ts`
