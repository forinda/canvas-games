...
**File:** `src/contexts/canvas2d/games/tower-defense/systems/EconomySystem.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/renderers/ParticleRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/tower-defense/renderers/HUDRenderer.ts`
