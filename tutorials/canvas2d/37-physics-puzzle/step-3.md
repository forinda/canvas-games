...
**File:** `src/contexts/canvas2d/games/physics-puzzle/systems/InventorySystem.ts`
...
**File:** `src/contexts/canvas2d/games/physics-puzzle/renderers/InventoryRenderer.ts`
