...
**File:** `src/contexts/canvas2d/games/physics-puzzle/types.ts`
...
**File:** `src/contexts/canvas2d/games/physics-puzzle/systems/PhysicsSystem.ts`
...
**File:** `src/contexts/canvas2d/games/physics-puzzle/renderers/WorldRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/physics-puzzle/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/physics-puzzle/index.ts`
