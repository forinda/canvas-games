...
**File:** `src/contexts/canvas2d/games/gravity-ball/types.ts`
...
**File:** `src/contexts/canvas2d/games/gravity-ball/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/gravity-ball/index.ts`
