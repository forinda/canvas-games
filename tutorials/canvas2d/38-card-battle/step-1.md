...
**File:** `src/contexts/canvas2d/games/card-battle/types.ts`
...
**File:** `src/contexts/canvas2d/games/card-battle/data/cards.ts`
...
**File:** `src/contexts/canvas2d/games/card-battle/renderers/BattleRenderer.ts`
