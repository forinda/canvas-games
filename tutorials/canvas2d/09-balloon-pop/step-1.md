...
**File:** `src/contexts/canvas2d/games/balloon-pop/types.ts`
...
**File:** `src/contexts/canvas2d/games/balloon-pop/renderers/GameRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/balloon-pop/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/balloon-pop/index.ts`
