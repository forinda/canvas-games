...
**File:** `src/contexts/canvas2d/games/asteroids/systems/WaveSystem.ts`
...
**File:** `src/contexts/canvas2d/games/asteroids/renderers/HUDRenderer.ts`
...
```
src/contexts/canvas2d/games/asteroids/
