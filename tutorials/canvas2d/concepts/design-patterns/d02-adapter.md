...
## Used In These Games
- **City Builder**: `src/contexts/canvas2d/games/city-builder/adapters/PlatformAdapter.ts` wraps `CityEngine`
- **Snake**: `src/contexts/canvas2d/games/snake/adapters/PlatformAdapter.ts` wraps `SnakeEngine`
- **Platformer**: `src/contexts/canvas2d/games/platformer/adapters/PlatformAdapter.ts` wraps `PlatformerEngine`
- **Physics Puzzle**: `src/contexts/canvas2d/games/physics-puzzle/adapters/PlatformAdapter.ts` wraps `PuzzleEngine`
