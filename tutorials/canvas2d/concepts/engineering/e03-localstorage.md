...
- **Snake**: High score is saved to localStorage so it persists across sessions. The `ScoreSystem` in `src/contexts/canvas2d/games/snake/systems/ScoreSystem.ts` reads and writes the best score.
