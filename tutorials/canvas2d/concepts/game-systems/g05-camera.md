...
- **Platformer**: The `CameraSystem` in `src/contexts/canvas2d/games/platformer/systems/CameraSystem.ts` follows the player horizontally and vertically with smooth interpolation, clamped to level bounds.
