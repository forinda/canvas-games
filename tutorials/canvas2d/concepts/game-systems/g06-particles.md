...
- **Tower Defense**: Explosions when enemies die, muzzle flashes from towers, and impact sparks on hits. The `ParticleRenderer` in `src/contexts/canvas2d/games/tower-defense/renderers/ParticleRenderer.ts` draws these effects.
