...
- **Tower Defense**: The core game loop. Waves of enemies march along the path with increasing speed, health, and count. The `WaveSystem` in `src/contexts/canvas2d/games/tower-defense/systems/WaveSystem.ts` manages timing and spawning.
