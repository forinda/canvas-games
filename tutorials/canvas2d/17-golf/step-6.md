...
**File:** `src/contexts/canvas2d/games/golf/data/courses.ts`
...
**File:** `src/contexts/canvas2d/games/golf/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/golf/index.ts`
