...
**File:** `src/contexts/canvas2d/games/lava-floor/renderers/HUDRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/lava-floor/systems/InputSystem.ts`
...
**File:** `src/contexts/canvas2d/games/lava-floor/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/lava-floor/index.ts`
...
```
src/contexts/canvas2d/games/lava-floor/
