...
**File:** `src/contexts/canvas2d/games/maze-runner/systems/PlayerSystem.ts`
...
**File:** `src/contexts/canvas2d/games/maze-runner/systems/TimerSystem.ts`
...
**File:** `src/contexts/canvas2d/games/maze-runner/renderers/HUDRenderer.ts`
