...
**File:** `src/contexts/canvas2d/games/fruit-ninja/systems/FruitSystem.ts`
...
**File:** `src/contexts/canvas2d/games/fruit-ninja/systems/BombSystem.ts`
...
**File:** `src/contexts/canvas2d/games/fruit-ninja/renderers/HUDRenderer.ts`
...
**File:** `src/contexts/canvas2d/games/fruit-ninja/index.ts`
