...
**File:** `src/contexts/canvas2d/games/memory-match/renderers/BoardRenderer.ts`
...
**Source Code:** [`src/contexts/canvas2d/games/memory-match/`](../../src/contexts/canvas2d/games/memory-match/)
