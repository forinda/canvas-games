...
**File:** `src/contexts/canvas2d/games/memory-match/data/icons.ts`
...
**File:** `src/contexts/canvas2d/games/memory-match/adapters/PlatformAdapter.ts`
...
**File:** `src/contexts/canvas2d/games/memory-match/index.ts`
