...
**File:** `src/games/particle-sand/types.ts`
...
**File:** `src/games/particle-sand/renderers/GameRenderer.ts`
...
**File:** `src/games/particle-sand/SandEngine.ts`
...
**File:** `src/games/particle-sand/adapters/PlatformAdapter.ts`
...
**File:** `src/games/particle-sand/index.ts`
