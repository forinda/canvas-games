...
**File:** `src/games/typing-speed/types.ts`
...
**File:** `src/games/typing-speed/data/words.ts`
...
**File:** `src/games/typing-speed/renderers/GameRenderer.ts`
...
**File:** `src/games/typing-speed/index.ts`
