...
**File:** `src/games/idle-clicker/renderers/GameRenderer.ts`
...
**File:** `src/games/idle-clicker/systems/ClickSystem.ts`
...
**File:** `src/games/idle-clicker/adapters/PlatformAdapter.ts`
...
**File:** `src/games/idle-clicker/index.ts`
