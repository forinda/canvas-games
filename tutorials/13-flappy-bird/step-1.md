...
**File:** `src/games/flappy-bird/types.ts`
...
**File:** `src/games/flappy-bird/systems/InputSystem.ts`
...
**File:** `src/games/flappy-bird/adapters/PlatformAdapter.ts`
...
**File:** `src/games/flappy-bird/index.ts`
