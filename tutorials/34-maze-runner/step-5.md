...
- **Final engine** matching the complete source at `src/games/maze-runner/`
...
**File:** `src/games/maze-runner/types.ts`
...
**File:** `src/games/maze-runner/adapters/PlatformAdapter.ts`
...
**File:** `src/games/maze-runner/index.ts`
