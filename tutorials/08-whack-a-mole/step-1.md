...
**File:** `src/games/whack-a-mole/types.ts`
...
**File:** `src/games/whack-a-mole/renderers/GameRenderer.ts`
...
**File:** `src/games/whack-a-mole/WhackEngine.ts`
...
**File:** `src/games/whack-a-mole/adapters/PlatformAdapter.ts`
...
**File:** `src/games/whack-a-mole/index.ts`
