...
**File:** `src/games/tower-defense/types/index.ts`
...
**File:** `src/games/tower-defense/systems/PathSystem.ts`
...
**File:** `src/games/tower-defense/GameState.ts`
...
**File:** `src/games/tower-defense/renderers/GridRenderer.ts`
...
**File:** `src/games/tower-defense/index.ts`
