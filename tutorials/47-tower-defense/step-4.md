...
**File:** `src/games/tower-defense/systems/TowerSystem.ts`
...
**File:** `src/games/tower-defense/systems/CombatSystem.ts`
...
**File:** `src/games/tower-defense/renderers/ProjectileRenderer.ts`
