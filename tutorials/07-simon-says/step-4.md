...
**File:** `src/games/simon-says/renderers/HUDRenderer.ts`
...
**File:** `src/games/simon-says/systems/InputSystem.ts`
...
**File:** `src/games/simon-says/SimonEngine.ts`
...
**File:** `src/games/simon-says/adapters/PlatformAdapter.ts`
...
**File:** `src/games/simon-says/systems/AudioSystem.ts` (Optional)
